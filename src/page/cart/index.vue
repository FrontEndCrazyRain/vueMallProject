<!--
 * @Author: 崔令雨
 * @Date: 2022-12-06 18:59:47
 * @LastEditors: [崔令雨]
 * @LastEditTime: 2022-12-06 19:09:18
 * @Description: 
-->
<template>
  <!-- 购物车列表 -->
      ...
      <div class="cart-body">
        <ul class="cart-list">
          ...
          <li class="cart-list-con2">
            <img src="../../../public/images/goods1.png" />
        ...
        <ul class="cart-list">
          ...
          <li class="cart-list-con2">
            <img src="../../../public/images/goods2.png" />
        ...
        <ul class="cart-list">
          ...
          <li class="cart-list-con2">
            <img src="../../../public/images/goods3.png" />
